    ...
    return(
        <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
            <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
                ...
                <p className='mt-4 text-gray-700'>Blog Category</p>
                <select onChange={e=> setCategory(e.target.value)} name="category" className='mt-2 px-3 py-2 border text-gary-200 border-gray-300 outline-none rounded'>
                ...
                <button disabled={isAdding} type="submit" className='mt-8 w-40 h-10 bg-black text-white rounded cursor-pointer text-sm'>{isAdding ? 'Adding...' : 'Add Blog' }</button>
            </div>
